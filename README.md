...
wget https://github.com/AchrafSoltani/proton-drive-gtk/releases/latest/download/proton-drive-gtk_1.1.0_all.deb

# Install
sudo dpkg -i proton-drive-gtk_1.1.0_all.deb
...
```bash
# Download latest release
wget https://github.com/AchrafSoltani/proton-drive-gtk/releases/latest/download/proton-drive-gtk-1.1.0-1.noarch.rpm

# Install (Fedora/RHEL)
sudo dnf install proton-drive-gtk-1.1.0-1.noarch.rpm

# Install (openSUSE)
sudo zypper install proton-drive-gtk-1.1.0-1.noarch.rpm
```
...
./build-deb.sh
sudo dpkg -i dist/proton-drive-gtk_1.1.0_all.deb

# Build .rpm (Fedora/RHEL) - requires rpm-build
./build-rpm.sh
sudo dnf install dist/proton-drive-gtk-1.1.0-1.noarch.rpm
```
